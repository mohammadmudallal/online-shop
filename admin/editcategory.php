                            ...
                            <form action="addcategory.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="description" style="resize: none;" rows="3" class="form-control" placeholder="Enter Description"><?= $data['description']; ?></textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="keyword" value="<?= $data['keyword']; ?>" placeholder="Enter Keyword" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary" name="update_cat_button">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
