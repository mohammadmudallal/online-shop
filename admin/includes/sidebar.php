...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#">
        <span class="ms-1 font-weight-bold text-white">ONE STOP SHOP</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "addcategory_form.php" ? 'active bg-gradient-primary':'' ?>" href="addcategory_form.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "addproduct_form.php" ? 'active bg-gradient-primary':'' ?>" href="addproduct_form.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-plus" aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "add_delivery_man.php" ? 'active bg-gradient-primary':'' ?>" href="add_delivery_man.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-plus"></i>
            </div>
            <span class="nav-link-text ms-1">Register Delivery</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "info.php" ? 'active bg-gradient-primary':'' ?>" href="info.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa fa-info-circle" aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Manage Info</span>
          </a>
        </li>
      </ul>
    </div>
